...
const NewsCard = ({ news }) => {
    ...
    return (
        <>
                <div onClick={handelNavigation} className="card flex flex-col my1 mx-1 cursor-pointer hover:shadow-sm hover:shadow-black rounded-none bg-base-100 shadow-xl">
